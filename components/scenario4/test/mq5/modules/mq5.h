...
float checkMQ5() {
  ...
  MQ5.setA(80.897); MQ5.setB(-2.431); // Configurate the ecuation values to get LPG concentration
  float LPG = MQ5.readSensor(); // Sensor will read PPM concentration using the model and a and b values setted before or in the setup
  Serial.print("LPGa : ");
  Serial.println(LPG);
