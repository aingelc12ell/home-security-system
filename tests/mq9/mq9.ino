...
MQUnifiedsensor MQ9("Arduino UNO", 5, 10, A0, "MQ-9");
...
void loop(){
  checkMQ9();
  MQ9Alarm = digitalRead(MQ9DO);
  if (MQ9Alarm == 1) digitalWrite(MQ9LED, HIGH); 
  else if (MQ9Alarm == 0) digitalWrite(MQ9LED, LOW); 
}
